...
public class UpdateByIdCommand{
    ...
    public ObjectResAns doo(HashSet<Organization> mySet, String s) {
        ...
        if (dt.length == 2) {
            ...
            return new ObjectResAns("update \"" + indexOfs + "\",\"" + name + "\",\"" + crX + "\",\"" + crY + "\",\"" + annualTurnover + "\",\"" + Static.orTp.getTypeById(tp).name() + "\",\"" + street + "\",\"" + zipCode + "\"", true);
        } else if (dt.length >= 9) {
            String nameNew = dt[2];
            ...
            return new ObjectResAns("update \"" + indexOfs + "\",\"" + nameNew + "\",\"" + cr.getX() + "\",\"" + cr.getY() + "\",\"" + anT + "\",\"" + o_type.name() + "\",\"" + ad.getStreet() + "\",\"" + ad.getZipCode() + "\"", true);
        }else {
